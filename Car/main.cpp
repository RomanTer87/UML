...
class Engine
{
	...
	double consumption;
	double consumptrion_per_second;
	bool is_started;
public:
	...
	double get_consumptrion_per_second()const
	{
		return consumptrion_per_second;
	}
	void set_consumptrion_per_second(double consumption)
	{
		consumptrion_per_second = consumption * 3e-5;
	}
	void start()
	{
		is_started = true;
	...
	set_consumptrion_per_second(consumption);
	is_started = false;
	...
	void info()const
	{
		...
		cout << "Consumption:\t" << consumptrion_per_second << " liters per 1 sec.\n";
	}
};
